...
import { Alert, Button, Image, Platform, StyleSheet, TextInput, View, Text } from "react-native";
...
export function CriarGrupo() {
 ...
 return (
    <View style={styles.container}>
      ...
      {groupImage && <Image source={{ uri: groupImage }} style={styles.image} />}
      <TextInput
        style={styles.input}
      ...
      <Text style={styles.dateText}>Data de Revelação: {dataRevelacao.toLocaleDateString()}</Text>
